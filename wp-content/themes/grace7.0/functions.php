...
{
	global $post;
	$_var_34 = get_post_meta($post->ID, 'cc_value', !0);
	switch ($_var_34) {
		case 1:
		...
		case 2:
			echo '<div class="post-declare">
			                    ...
			                    <p>转载文章，作者：' . get_post_meta($post->ID, 'cus_author_name', !0) . '，出处：' . get_post_meta($post->ID, 'other_posturl', !0) . '</p>
			                </div>';
			break;
		default:
			break;
