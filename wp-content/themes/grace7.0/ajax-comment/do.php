	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">		
		...
		<div class="comment-body">
			<div class="comment_author">
				...
				<?php if($comment->user_id == 1) echo "<span class='comment_admin'>".suxingme("suxing_site_admin_name","官方")."</span>"; ?>
				<em><?php echo get_comment_time('Y-m-d H:i') ?></em><?php edit_comment_link('编辑','&nbsp;&nbsp;',''); ?>
			</div>
...
if( suxingme('suxing_some_chinese',true) ){    
...
if( suxingme('suxing_comment_no_html',true) ){ 
