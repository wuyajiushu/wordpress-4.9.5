<?php if( suxingme('suxing_ad_posts_pc') && !wp_is_mobile()){  ?>
	<?php
		...
		<?php endif; ?>
<?php } ?>
<?php if( suxingme('suxing_ad_posts_m') && wp_is_mobile() ){  ?>
	<?php
	...
	<div class="content-box posts-aside">
		<div class="posts-default-content">
			<div class="posts-default-title">
				...
				<h2><?php echo suxing_post_state_date()?><a href="<?php the_permalink(); ?>" title="<?php the_title();?>" <?php if( suxingme('suxingme_post_target')) { echo 'target="_blank"';}?>><?php the_title();?></a></h2>
			</div>
			...
			<div class="posts-default-info">
				<ul>
					<?php  if($dis_author == 1) { 
								if( $cc_value != 2 ){?> 
									<li class="post-author"><div class="avatar"><?php echo get_avatar( get_the_author_meta('ID') ); ?></div><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ) ?>" target="_blank"><?php echo get_the_author() ?></a></li>
								<?php } else { ?>  
										<li class="post-author"><div class="avatar"><?php echo cc_avatar(); ?></div><?php echo get_post_meta($post->ID,'cus_author_name',true); ?></li>
								<?php } ?>
					<?php } if( $cc_value == 1 ) { ?>
						<li class="postoriginal"><span><i class="icon-cc-1"></i><?php echo suxingme('suxingme_custom_cc');?></span></li>
					...
					<?php } if($dis_view == 1) { ?>
						<li class="ico-eye"><i class="icon-eye-4"></i> <?php post_views('',''); ?></li>
					<?php }  if($dis_like == 1) { ?><li class="ico-like"><i class="icon-heart"></i> <?php if( get_post_meta($post->ID,'suxing_ding',true) ){ echo get_post_meta($post->ID,'suxing_ding',true); } else {echo '0';}?></li><?php } ?>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="posts-default-content">
				...
				<div class="posts-default-info">
					...
					<?php }	if($dis_cat == 1) { ?>
						...
						<?php } if($dis_view == 1) { ?>
							<li class="ico-eye"><i class="icon-eye-4"></i> <?php post_views('',''); ?></li>
						<?php }  if($dis_like == 1) { ?><li class="ico-like"><i class="icon-heart"></i> <?php if( get_post_meta($post->ID,'suxing_ding',true) ){ echo get_post_meta($post->ID,'suxing_ding',true); } else {echo '0';}?></li>
						<?php } ?>
					</ul>
				</div>
			</div>
