...
define('Z_IMAGE_PLACEHOLDER', get_template_directory_uri()."/img/placeholder.png");
// l10n
...
function z_script() {
	...
	return '<script type="text/javascript">
	    jQuery(document).ready(function($) {
			var wordpress_ver = "'.$wp_version.'", upload_button;
...
function z_quick_edit_custom_box($column_name, $screen, $name) {
	if ($column_name == 'thumb') 
		...
		<div class="thumb inline-edit-col">
			<label>
				<span class="title"><img src="'.z_taxonomy_image_url( $taxonomy->term_id, NULL, TRUE ).'" alt="Thumbnail"/></span>
				<span class="input-text-wrap"><input type="text" name="taxonomy_image" value="'.z_taxonomy_image_url( $taxonomy->term_id, NULL, TRUE ).'" class="tax_list" /></span>
